...
public class UserLookupController {
    ...
    public ResponseEntity<UserLookupResponse> getAllUsers() {
        try {
            ...
            var safeErrorMessage = "Error while processing request to get all users";
    ...
    public ResponseEntity<UserLookupResponse> getUserById(@PathVariable(value = "id") String id) {
        try {
            ...
            var safeErrorMessage = "Error while processing request to get user by ID";
            System.out.println(e.toString());
    ...
    public ResponseEntity<UserLookupResponse> searchUsersByFilter(@PathVariable(value = "filter") String filter) {
        try {
            ...
            var safeErrorMessage = "Error while processing request to search users by filter";
            System.out.println(e.toString());
